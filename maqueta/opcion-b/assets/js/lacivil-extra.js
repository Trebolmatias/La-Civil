/* ===== Asociación del Personal Jerárquico BNA — comportamiento extra (Opción B) =====
...
(function () {
  ...
  ready(function () {
    ...
    if (!document.querySelector('.wa-float')) {
      ...
      wa.href = 'https://wa.me/5491136875696';
    ...
    var modalsHTML =
      '<div class="lc-modal-ov" id="lcLogin" role="dialog" aria-modal="true" aria-labelledby="lcLoginT">' +
        '<div class="lc-modal">' +
          ...
          '<img class="lc-logo" src="' + LOGO + '" alt="Asociación del Personal Jerárquico del Banco Nación">' +
          '<h3 id="lcLoginT">Ingresar</h3>' +
          '<p class="lc-sub">Accedé al área de socios de la Asociación.</p>' +
          '<form data-demo>' +
      ...
      '<div class="lc-modal-ov" id="lcRegister" role="dialog" aria-modal="true" aria-labelledby="lcRegT">' +
        '<div class="lc-modal">' +
          ...
          '<p class="lc-sub">Sumate a la Asociación y accedé a todos los beneficios.</p>' +
          '<form data-demo>' +
            '<div class="lc-row2">' +
