...
(function () {
  ...
  var pin = '<svg class="ic ic-sm" viewBox="0 0 24 24"><path d="M12 21s7-6.3 7-11a7 7 0 0 0-14 0c0 4.7 7 11 7 11z"/><circle cx="12" cy="10" r="2.5"/></svg>';
  function thumb(l) {
    var src = IMG[l.id];
  ...
  list.innerHTML = order.map(function (o) {
    ...
    return '<div class="hcard" data-idx="' + i + '">' +
      ...
      '<span class="hc-chev"><svg class="ic ic-sm"><use href="#ic-arrow"/></svg></span></div>' +
